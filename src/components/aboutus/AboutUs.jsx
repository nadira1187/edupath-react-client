        ...
        <div>
            ...
            <div className="mt-5 ml-5 mb-5 grid grid-cols-1 md:grid-cols-2 gap-3 justify-center items-center">
                <div data-aos="zoom-in">
                    ...
                    <h3 className="text-2xl font-semibold">Empowering Through Learning</h3>
                ...
                <div data-aos="zoom-in-up">
                    ...
                    <h3 className="text-2xl font-semibold"> Navigating Career Opportunities</h3>
                ...
                <div data-aos="zoom-in">
                    ...
                    <h3 className="text-2xl font-semibold">Shaping the Future of Education</h3>
                ...
                <div data-aos="zoom-in-up">
                    ...
                    <h3 className="text-2xl font-semibold">Unlocking Your Potential</h3>
